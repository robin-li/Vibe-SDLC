...
> **版本**：v1.3 (Vibe-Coding / 基於 AI Agentic 架構)
> **開發周期**：1-2 周
...
- [ ] T-602 (A-Backend) 後端錯誤訊息多語化
- [ ] T-603 (A-Backend) AI Prompt 多語化
- [x] T-604 (A-Frontend) i18n 基礎建設（前端） — PR #149 merged 2026-03-22
- [ ] T-605 (A-Frontend) 前端 UI 多語化
- [ ] T-606 (A-Frontend) 語言設定與偏好持久化
- [ ] T-607 (A-QA) i18n E2E 測試
- [ ] [驗證] T-605 四語言 UI 切換視覺驗收 (H-UxReviewer)
- [ ] ⛳ M6 驗收門
